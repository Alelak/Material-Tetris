function TetriminosS(ctx, direction, canvas) {
    ...
    this.animateSquare = function (dir, grid) {
        ...
        if (self.squares[3].i < 19 && !self.checkCollisionNormal(grid)) {
            ...
            } else if (dir == direction.LEFT && ((self.squares[3].j > 0 && self.horizontal) || (self.squares[1].j > 0 && !self.horizontal)) && !self.checkCollisionLeft(grid)) {
                for (var k = 0; k < self.squares.length; k++) {
                    self.squares[k].j--;
                }
            } else if (dir == direction.RIGHT && ((self.squares[0].j < 13 && self.horizontal) || (self.squares[3].j < 13 && !self.horizontal)) && !self.checkCollisionRight(grid)) {
                for (var k = 0; k < self.squares.length; k++) {
                    self.squares[k].j++;
                }
            }
    ...
    this.checkCollisionNormal = function (grid) {
        ...
        if (self.horizontal) {
            ...
            if (self.squares[2].i + 1 < 19 && grid[self.squares[0].i + 1][self.squares[0].j] == true ||
            ...
            if (self.squares[3].i + 1 < 19 && grid[self.squares[2].i + 1][self.squares[2].j] == true ||
                grid[self.squares[3].i + 1][self.squares[3].j] == true) {
                collision = true;
            }
        }
    ...
    this.checkCollisionLeft = function (grid) {
        ...
        if (self.horizontal) {
            ...
            if (self.squares[3].j - 1 > 0 && grid[self.squares[3].i][self.squares[3].j - 1] == true ||
            ...
            if (self.squares[1].j - 1 > 0 && grid[self.squares[1].i][self.squares[1].j - 1] == true ||
    ...
    this.checkCollisionRight = function (grid) {
        ...
        if (self.horizontal) {
            ...
            if (self.squares[0].j + 1 < 13 && grid[self.squares[0].i][self.squares[0].j + 1] == true ||
                grid[self.squares[2].i][self.squares[2].j + 1] == true) {
                collision = true;
            }
        } else {
